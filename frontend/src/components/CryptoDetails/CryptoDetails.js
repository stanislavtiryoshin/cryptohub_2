...
const CryptoDetails = ({ followedCoins }) => {
  ...
  useEffect(() => {
    setIsFollowed(followedCoins.some(coin => coin.uuid === coinId))
  }, [followedCoins])
  ...
  return (
    ...
    <div className="details-heading">
      ...
      <h1>
        ...
        <button className={isFollowed ? 'btn-ex inactive' : 'btn-ex'} onClick={() => followCoin()} >{isFollowed ? `Followed` : `Not Followed`}</button>
      </h1>
